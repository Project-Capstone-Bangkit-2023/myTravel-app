...
class PlaceAdapter(private val context: Context, private val listPlace: List<Place>) : RecyclerView.Adapter<PlaceAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (id, name, category, photo, city, rating, price, desc, lat, lon) = listPlace[position]
